	...
	function init_template(){
       ...
       $(".text-size-default").click(function() {$(".text-size-changer *").css("font-size", "");});
        ...
        if(!$('.offline-message').length){
            $('#page').append('<p class="offline-message bg-red2-dark color-white center-text uppercase ultrabold">No se detectó conexión a internet</p>');
            $('#page').append('<p class="online-message bg-green1-dark color-white center-text uppercase ultrabold">Estás de nuevo en línea. ¡Bienvenido! Bienestar Universitario</p>');
        }     
